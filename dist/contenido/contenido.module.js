...
exports.ContenidoModule = ContenidoModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([contenido_home_entity_1.ContenidoHome])],
        controllers: [contenido_controller_1.ContenidoController],
        providers: [contenido_service_1.ContenidoService],
        exports: [contenido_service_1.ContenidoService],
    })
], ContenidoModule);
